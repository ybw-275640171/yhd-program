    ...
    if (xhr.readyState == 4) {
      if (xhr.status >= 200 && xhr.status < 300) {
        ...
        $.each(res, function (index, item) {
          var goodsDom = '<li class="goodscon">' + '<a class="goodsimg">' + '<img src="' + item.imgurl + '" alt="">' + '</a>' + '<p class="goodsname">' + item.title + '</p>' + '<p class="goodsprice">' + item.price + ' </p>' + '<div class="goodscart">' + ' <div class="goodsadd">' + '<a code="' + item.code + '" href="">' + ' <i class="goodscart1 iconfont icon-gouwuchezhengpin"></i>' + '</a>' + ' </div>' + '<div class="goodsseem">' + '<a href="">找相似</a>' + '</div>' + ' </div>' + '</li>';
